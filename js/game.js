...
function setupQuarkStage(){
  ...
  player.quarkstage.producers.push(new Producer("quarkgentwo",     "Generator 2",  [new ExponentialCost(player.quarkstage.quarks, "5e1", 1.1)],         [new LinearProduction(player.quarkstage.quarks, "4.5")],      [new NumRequirement(player.quarkstage.producers[0], new Decimal(10))], "quarkgen"));
  ...
  player.quarkstage.producers.push(new Producer("quarkgenseven",   "Generator 7",  [new ExponentialCost(player.quarkstage.quarks, "1e19", 1.1)],    [new LinearProduction(player.quarkstage.quarks, "1e12")],    [new NumRequirement(player.quarkstage.producers[5], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgeneight",   "Generator 8",  [new ExponentialCost(player.quarkstage.quarks, "1", 1.1)],   [new LinearProduction(player.quarkstage.quarks, "1")],   [new NumRequirement(player.quarkstage.producers[6], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgennine",    "Generator 9",  [new ExponentialCost(player.quarkstage.quarks, "1", 1.1)],  [new LinearProduction(player.quarkstage.quarks, "1")],  [new NumRequirement(player.quarkstage.producers[7], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgenten",     "Generator 10", [new ExponentialCost(player.quarkstage.quarks, "1", 1.1)], [new LinearProduction(player.quarkstage.quarks, "1")], [new NumRequirement(player.quarkstage.producers[8], new Decimal(10))], "quarkgen"));
