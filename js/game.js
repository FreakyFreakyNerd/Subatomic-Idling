...
function setupQuarkStage(){
  ...
  player.quarkstage.producers.push(new Producer("quarkgentwo",     "Generator 2",  [new ExponentialCost(player.quarkstage.quarks, 50, 1.1)],         [new LinearProduction(player.quarkstage.quarks, 5)],      [new NumRequirement(player.quarkstage.producers[0], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgenthree",   "Generator 3",  [new ExponentialCost(player.quarkstage.quarks, 500, 1.1)],        [new LinearProduction(player.quarkstage.quarks, 50*.9)],      [new NumRequirement(player.quarkstage.producers[1], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgenfour",    "Generator 4",  [new ExponentialCost(player.quarkstage.quarks, 5000, 1.1)],       [new LinearProduction(player.quarkstage.quarks, 500*Math.pow(.9,2))],     [new NumRequirement(player.quarkstage.producers[2], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgenfive",    "Generator 5",  [new ExponentialCost(player.quarkstage.quarks, 50000, 1.1)],      [new LinearProduction(player.quarkstage.quarks, 5000*Math.pow(.9,3))],     [new NumRequirement(player.quarkstage.producers[3], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgensix",     "Generator 6",  [new ExponentialCost(player.quarkstage.quarks, 500000, 1.1)],     [new LinearProduction(player.quarkstage.quarks, 50000*Math.pow(.9,4))],    [new NumRequirement(player.quarkstage.producers[4], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgenseven",   "Generator 7",  [new ExponentialCost(player.quarkstage.quarks, 5000000, 1.1)],    [new LinearProduction(player.quarkstage.quarks, 500000*Math.pow(.9,5))],    [new NumRequirement(player.quarkstage.producers[5], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgeneight",   "Generator 8",  [new ExponentialCost(player.quarkstage.quarks, 50000000, 1.1)],   [new LinearProduction(player.quarkstage.quarks, 5000000*Math.pow(.9,6))],   [new NumRequirement(player.quarkstage.producers[6], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgennine",    "Generator 9",  [new ExponentialCost(player.quarkstage.quarks, 500000000, 1.1)],  [new LinearProduction(player.quarkstage.quarks, 50000000*Math.pow(.9,7))],  [new NumRequirement(player.quarkstage.producers[7], new Decimal(10))], "quarkgen"));
  player.quarkstage.producers.push(new Producer("quarkgenten",     "Generator 10", [new ExponentialCost(player.quarkstage.quarks, 5000000000, 1.1)], [new LinearProduction(player.quarkstage.quarks, 500000000**Math.pow(.9,8))], [new NumRequirement(player.quarkstage.producers[8], new Decimal(10))], "quarkgen"));
  ...
  player.quarkstage.upgrades.push(new Upgrade("quarkgen1-5upgradeexponentialone", "Multiplier 4", -1, [new NumRequirement(player.quarkstage.upgrades[2],10)], [new ExponentialEffect([player.quarkstage.producers[0],player.quarkstage.producers[1],player.quarkstage.producers[2],player.quarkstage.producers[3],player.quarkstage.producers[4]], 1, 6, EffectTypes.ProducerMultiplierProduction, "Quark Generators 1-5")], [new ExponentialCost(player.quarkstage.quarks,1e10,10)], "quarkupg"));
  player.quarkstage.upgrades.push(new Upgrade("quarkgen6-10upgradeexponentialone", "Multiplier 5", -1, [new NumRequirement(player.quarkstage.upgrades[3],10)], [new ExponentialEffect([player.quarkstage.producers[5],player.quarkstage.producers[6],player.quarkstage.producers[7],player.quarkstage.producers[8],player.quarkstage.producers[9]], 1, 4, EffectTypes.ProducerMultiplierProduction, "Quark Generators 6-10")], [new ExponentialCost(player.quarkstage.quarks,1e16,100)], "quarkupg"));
