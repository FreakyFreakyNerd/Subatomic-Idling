...
function setupbasicelectronupgrades(){
    ...
    var quarkspinmult = () => Decimal.pow(1.05, Decimal.pow(Decimal.log(totalproducerbought(player.electronstage.quarkspinproducers)), 2.5));
...
function setupbasicelectroncloud(){
    ...
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3s", "Orbital 3S", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3p", "Orbital 3P", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4s", "Orbital 4S", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("3d", "Orbital 3D", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4p", "Orbital 4P", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5s", "Orbital 5S", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4d", "Orbital 4D", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5p", "Orbital 5P", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("6s", "Orbital 6S", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("4f", "Orbital 4F", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5d", "Orbital 5D", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("6p", "Orbital 6P", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("7s", "Orbital 7S", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("5f", "Orbital 5F", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power));
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("7p", "Orbital 7P", new LinearEffect(player.challenges, 1, .01, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge Score *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "2"), player.electronstage.clouds.power, new AchievementRequirement("applebottomgenes")));
}
