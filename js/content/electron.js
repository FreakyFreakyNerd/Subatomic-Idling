...
function setupbasicelectronupgrades(){
    ...
    var chargemultmax = () => { if(totalproducerbought(player.quarkstage.producers).equals(1)) return "1e100"; else return "1e15"; }
...
function setupbasicelectronupgradesstage2(){
  ...
  player.electronstage.upgrades.push(new Upgrade("eu14", "[e15] Slightly Increase Electron Gain and Quark Gain", 1000, null, [new ExponentialEffect(player.quarkstage.producers, 1, 1.01, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Quark Production *" + formatDecimalOverride(obj.value, 2))], new ExponentialCost(player.electronstage.electrons, "1e52", 1.05), "upg", {"showall": true}));
}
