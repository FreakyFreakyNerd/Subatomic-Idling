...
function setupquarkspinproducers(){
  ...
  player.electronstage.quarkspinproducers.push(new Producer("qs2", "Red Quark", [new ExponentialCost(player.electronstage.electrons, "10", 3)], [new LinearProduction(player.electronstage.quarkspinproducers[0], "1")], null, "qsp"));
  player.electronstage.quarkspinproducers.push(new Producer("qs3", "Blue Quark", [new ExponentialCost(player.electronstage.electrons, "1e3", 4)], [new LinearProduction(player.electronstage.quarkspinproducers[1], "1")], null, "qsp"));
  player.electronstage.quarkspinproducers.push(new Producer("qs4", "Antigreen Quark", [new ExponentialCost(player.electronstage.electrons, "1e6", 4)], [new LinearProduction(player.electronstage.quarkspinproducers[2], "1")], null, "qsp"));
  player.electronstage.quarkspinproducers.push(new Producer("qs5", "Antired Quark", [new ExponentialCost(player.electronstage.electrons, "1e12", 4)], [new LinearProduction(player.electronstage.quarkspinproducers[3], "1")], null, "qsp"));
  player.electronstage.quarkspinproducers.push(new Producer("qs6", "Antiblue Quark", [new ExponentialCost(player.electronstage.electrons, "1e24", 10)], [new LinearProduction(player.electronstage.quarkspinproducers[4], "1")], null, "qsp"));
  player.electronstage.quarkspinproducers.push(new Producer("qs7", "Meson Quark", [new ExponentialCost(player.electronstage.electrons, "1e48", 100)], [new LinearProduction(player.electronstage.quarkspinproducers[5], "1e-6")], null, "qsp"));
  player.electronstage.quarkspinproducers.push(new Producer("qs8", "Baryon Quark", [new ExponentialCost(player.electronstage.electrons, "1e96", 1000)], [new LinearProduction(player.electronstage.quarkspinproducers[6], "1e-10")], null, "qsp"));
  player.electronstage.quarkspinproducers.push(new Producer("qs9", "Antibaryon Quark", [new ExponentialCost(player.electronstage.electrons, "1e200", 10000)], [new LinearProduction(player.electronstage.quarkspinproducers[7], "1e-20")], null, "qsp"));
  player.electronstage.quarkspinproducers.push(new Producer("qs10", "Metaphysical Quark", [new ExponentialCost(player.electronstage.electrons, "1e500", 100000)], [new LinearProduction(player.electronstage.quarkspinproducers[8], "1e-100")], null, "qsp"));
}
...
function setupbasicelectronupgrades(){
    ...
    var chargermult = () => Decimal.min(Decimal.max(Decimal.pow(player.quarkstage.quarks.amount, .25).times(Decimal.pow(.1, totalproducerbought(player.quarkstage.producers).minus(1))).add(1), Decimal.pow(player.quarkstage.quarks.amount, .1).add(1)), 1e10);
...
function setupbasicquarkspinupgrades(){
    ...
    player.electronstage.quarkspinupgrades.push(new Upgrade("su1", "Respinner", -1, null, [new ExponentialEffect(player.electronstage.quarkspinproducers, 1, 1.1, EffectTypes.ProducerMultiplierProduction, null, (obj) => "Respinner Power *" + formatDecimalOverride(obj.increase, 1) + " | Quark Spin Producers *" + formatDecimalOverride(obj.value, 2))], [new ExponentialCost(player.electronstage.quarkspin, "1e3", 10)], "qsp"));
    player.electronstage.quarkspinupgrades.push(new Upgrade("su2", "Aceleron Plus", -1, null, [new LinearEffect(player.quarkstage.upgrades[0], 1, .5, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Acceleron Power +" + formatDecimalOverride(obj.increase,1) + " | Acceleron power *" + formatDecimalOverride(obj.value, 1))], [new ExponentialCost(player.electronstage.quarkspin, "1e6", 25)], "qsp"));
    player.electronstage.quarkspinupgrades.push(new Upgrade("su3", "Multor Plus", -1, null, [new LinearEffect(player.quarkstage.upgrades[5], 1, .001, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => "Multor Power +" + formatDecimalOverride(obj.increase,3) + " | Multor power *" + formatDecimalOverride(obj.value, 3))], [new ExponentialCost(player.electronstage.quarkspin, "1e12", 100)], "qsp"));
    player.electronstage.quarkspinupgrades.push(new Upgrade("su4", "Better Challenges", -1, null, [new ExponentialEffect([player.challenges[0],player.challenges[1],player.challenges[2],player.challenges[3]], 1, 1.1, EffectTypes.ChallengeScoreMult, null, (obj) => "Challenge 1-4 Score *" + formatDecimalOverride(obj.value, 2))], [new ExponentialCost(player.electronstage.quarkspin, "1e20", "1e5")], "qsp"));
}
...
function setupbasicelectroncloud(){
    ...
    player.electronstage.clouds.orbitals.push(new AppliedToUpgrade("6s", "Orbital 6S", new LinearEffect(player.quarkstage.upgrades, 1, .01, EffectTypes.UpgradeAmountMultiplier, null, (obj) => "Quark Producers Upgrades Effective Amount *" + formatDecimalOverride(obj.value,2) + "(+" + formatDecimalOverride(obj.increase,2) + ")"), new ExponentialCost(null, "1e3", "1e3"), player.electronstage.clouds.power, new AchievementRequirement("10multron")));
