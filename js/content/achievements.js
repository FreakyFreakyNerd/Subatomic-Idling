function setupachievements(){
  ...
  player.achievements[0].push(new Achievement("1e3quarkgenone", "Wo! Calm down. ;)", [new NumRequirement(player.quarkstage.producers[0], 1e3)], null, [new FlavorEffect("Something Sometime.")]));
  ...
  player.achievements[1].push(new Achievement("1e3quarkgentwo", "You spin me right round, right round!", [new NumRequirement(player.quarkstage.producers[1], 1e3)], null, [new FlavorEffect("Something Sometime.")]));
  ...
  player.achievements[2].push(new Achievement("1e3quarkgenthree", "Flip it and slap it!", [new NumRequirement(player.quarkstage.producers[2], 1e3)], null, [new FlavorEffect("Something Sometime.")]));
  ...
  player.achievements[3].push(new Achievement("1e3quarkgenfour", "True loves kiss!", [new NumRequirement(player.quarkstage.producers[3], 1e3)], null, [new FlavorEffect("Something Sometime.")]));
  ...
  player.achievements[4].push(new Achievement("1e3quarkgenfive", "Time to sloooow dooooowwwwwwwwn", [new NumRequirement(player.quarkstage.producers[4], 1e3)], null, [new FlavorEffect("Something sometime.")]));
  ...
  player.achievements[5].push(new Achievement("1e3quarkgensix", "A college of Georges", [new NumRequirement(player.quarkstage.producers[5], 1e3)], null, [new FlavorEffect("Something sometime.")]));
  ...
  player.achievements[9].push(new Achievement("1e3quarkgenten", "Time flies.", [new NumRequirement(player.quarkstage.producers[9], 1e3)], null, [new FlavorEffect("Something Sometime.")]));
