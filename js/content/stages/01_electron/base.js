function setupElectronStage(){
  ...
  player.electronstage.upgrades.push(new Upgrade("eu3", "[e4] Get 10 free Accelerons, and 3 free Multors.", 1, null, [new StaticEffect(player.quarkstage.upgrades[5], 2, EffectTypes.UpgradeBonusLevels, null, () => "I dont know go ahead and take some more")], [new StaticCost(player.electronstage.electrons, "1e4")], "upg"))
