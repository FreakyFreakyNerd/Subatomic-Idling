function setupQuarkStage(){
  ...
  function boughtmult(amount) 
  {
    var val = Decimal.pow(Decimal.log(amount,2), 3)
    if(val.lessThan(1))
      return new Decimal("1");
    return val;
  }

  player.quarkstage.singletonupgrades.push(new Upgrade("qsu0", "[qu1] Increase charger production based on chargers bought",            1, null, [new FunctionEffect(player.quarkstage.producers[0], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[0].amount), (obj) => "Charger Production x"       + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e6")] , "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu1", "[qu2] Increase spinner production based on spinners bought",            1, null, [new FunctionEffect(player.quarkstage.producers[1], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[1].amount), (obj) => "Spinner Production x"       + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e8")] , "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu2", "[qu3] Increase flipper production based on flippers bought",            1, null, [new FunctionEffect(player.quarkstage.producers[2], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[2].amount),  (obj) => "Flipper Production x"      + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e10")], "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu3", "[qu4] Increase charmer production based on charmers bought",            1, null, [new FunctionEffect(player.quarkstage.producers[3], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[3].amount), (obj) => "Charmer Production x"       + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e12")], "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu4", "[qu5] Increase eightfold way production based on eightfoldways bought", 1, null, [new FunctionEffect(player.quarkstage.producers[4], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[4].amount), (obj) => "Eightfold Way Production x" + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e14")], "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu5", "[qu6] Increase george production based on georges bought",              1, null, [new FunctionEffect(player.quarkstage.producers[5], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[5].amount), (obj) => "George Production x"        + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e16")], "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu6", "[qu7] Increase murray production based on murrays bought",              1, null, [new FunctionEffect(player.quarkstage.producers[6], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[6].amount), (obj) => "Murray Production x"        + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e18")], "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu7", "[qu8] Increase epoch production based on epochs bought",                1, null, [new FunctionEffect(player.quarkstage.producers[7], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[7].amount), (obj) => "Epoch Production x"         + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e20")], "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu8", "[qu9] Increase scattering production based on scatterings bought",      1, null, [new FunctionEffect(player.quarkstage.producers[8], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[8].amount), (obj) => "Scattering Production x"    + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e22")], "upgrades"));
  player.quarkstage.singletonupgrades.push(new Upgrade("qsu9", "[qu10] Increase big bang production based on big bangs bought",         1, null, [new FunctionEffect(player.quarkstage.producers[9], EffectTypes.ProducerMultiplierProduction, () => boughtmult(player.quarkstage.producers[9].amount), (obj) => "Big Bang Production x"      + formatDecimalNormal(obj.value))], [new StaticCost(player.quarkstage.quarks, "1e24")], "upgrades"));
  ...
  player.quarkstage.upgrades.push(new Upgrade("qu1", "Accelerator",         -1, [new AchievementRequirement("imp")],            [new LinearEffect(player.quarkstage.upgrades[0], 1, .01, EffectTypes.UpgradeIncreaseMultiplier, null, (obj) => {return "Accelerator Power: +" + formatDecimalOverride(obj.increase, 2) + " || Acceleron Power: x" + formatDecimalOverride(obj.value, 2)})], [new ExponentialCost(player.quarkstage.quarks,1e5,2)], "quarkupg"));
