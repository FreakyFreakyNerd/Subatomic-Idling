function setupchallenges(){
  ...
  player.challenges.push(new Challenge("c1", "[c1] Quark Cut", "Electrify and reach the goal, but quark production is reduced heavily.", c1effect , [c1bonus1], new NumRequirement(player.quarkstage.quarks, new Decimal("1e16")), 100, () => {player.quarkstage.electrify.prestige();}));
