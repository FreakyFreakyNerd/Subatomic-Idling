function setupchallenges(){
  ...
  player.challenges.push(new Challenge("c1x1", "[c1] Quark Cut", "Electrify and gain score, but quark production is reduced heavily.", c1effect , [new Decimal(10), c1bonus1, new Decimal("1e15"), c1bonus2, new Decimal("1e40"), c1bonus3], 10, () => {player.quarkstage.electrify.prestige();}, null, () => player.quarkstage.quarks.gained, 2, [1, .5, .5, 10], "Quarks Gained"));
  ...
  player.challenges.push(new Challenge("c1x2", "[c2] Who needs the Acceleron line anyways", "Electrify and gain score, but all Acceleron line upgrades have a weakened effect", c2effect, [new Decimal(10) ,c2bonus1, new Decimal("1e5"), c2bonus2, new Decimal("1e10"), c2bonus3], 10, () => {player.quarkstage.electrify.prestige();}, null, ch2basescore, 1.5, [3, 1, .1, 5], "All Acceleron Line (Acceleron-Accerlation Boost) Amounts Multiplied Together Squared"));
  ...
  player.challenges.push(new Challenge("c1x3", "[c3] Who needs the Multor line anyways", "Electrify and gain score, but all Multor line upgrades have a weakened effect", c3effect, [new Decimal(10) ,c3bonus1, new Decimal("1e5"), c3bonus2, new Decimal("1e10"), c3bonus3], 10, () => {player.quarkstage.electrify.prestige();}, null, ch3basescore, 1.5, [3, .1, 1, 5], "All Multor Line (Multor-Multiplication Boost) Amounts Multiplied Together Squared"));
  ...
  player.challenges.push(new Challenge("c1x4", "[c4] Only 1", "Electrify and gain points, but you only can buy 1 Charger.", c4effects, [new Decimal("10"), c4bonus1, new Decimal("1e25"), c4bonus2, new Decimal("1e40"), c4bonus3], 1, () => {player.quarkstage.electrify.prestige();}, null, () => new Decimal(Decimal.pow(player.quarkstage.quarks.gained, 1/2)), 1, [.1, 5, 5, 1], "(Quarks Gained)^.5"));  
  ...
  player.challenges.push(new Challenge("c2x1", "[c5] Quarky", " Who needs any quark spin anyways", c5effects, [], 1, () => {player.electronstage.nucleonize.prestige();}, null, () => player.quarkstage.quarks, 1, [100, 2, 2, 2, 0], "Quarks Gained", [new AchievementRequirement("nucleonunlock")]));
}
