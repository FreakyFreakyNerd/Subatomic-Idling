function setupchallenges(){
    ...
    player.challenges.push(new Challenge("c1x1", "[c1x1] Quark Cut", "Electrify and gain score, but quark production is reduced heavily.", c1effect , [new Decimal(10), c1bonus1, new Decimal("1e15"), c1bonus2, new Decimal("1e45"), c1bonus3], 10, () => {player.quarkstage.electrify.prestige();}, null, () => player.quarkstage.quarks.gained, 1.5));
    ...
    player.challenges.push(new Challenge("c1x2", "[c1x2] Who needs the Acceleron line anyways", "Electrify and gain score, but all Acceleron line upgrades have a weakened effect", c2effect, [new Decimal(10) ,c2bonus1, new Decimal("1e5"), c2bonus2, new Decimal("1e15"), c2bonus3], 10, () => {player.quarkstage.electrify.prestige();}, null, ch2basescore, 1.75));
    ...
    player.challenges.push(new Challenge("c1x3", "[c1x3] Who needs the Multor line anyways", "Electrify and gain score, but all Multor line upgrades have a weakened effect", c3effect, [new Decimal(10) ,c3bonus1, new Decimal("1e5"), c3bonus2, new Decimal("1e15"), c3bonus3], 10, () => {player.quarkstage.electrify.prestige();}, null, ch3basescore, 1.75));
    ...
    player.challenges.push(new Challenge("c1x4", "[c1x3] Only 1", "Electrify and reach the goal, but you only can buy 1 Charger.", c4effects, [new Decimal("10"), c4bonus1, new Decimal("1e25"), c4bonus2, new Decimal("1e60"), c4bonus3], 1, () => {player.quarkstage.electrify.prestige();}, null, () => new Decimal(Decimal.pow(player.quarkstage.quarks.gained, 1/2)), 1.5));  
