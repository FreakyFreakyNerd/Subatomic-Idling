function setupchallenges(){
  ...
  var c4bonus3 = new FunctionEffect(player.quarkstage.producers[0], EffectTypes.ProducerMultiplierProduction, (amount) => new Decimal(Decimal.log(amount, 10)), (obj) => { return "Charger Production * Log1e10(score) || Charger Production ^" + formatDecimalOverride(obj.value, 2)});
  player.challenges.push(new Challenge("c1x4", "[c4] Only 1", "Electrify and reach the goal, but you only can buy 1 Charger.", c4effects, [new Decimal("10"), c4bonus1, new Decimal("1e25"), c4bonus2, new Decimal("1e60"), c4bonus3], 1, () => {player.quarkstage.electrify.prestige();}, null, () => new Decimal(Decimal.pow(player.quarkstage.quarks.gained, 1/2)), 1, [.1, 5, 5, 1], "(Quarks Gained)^.5"));  
