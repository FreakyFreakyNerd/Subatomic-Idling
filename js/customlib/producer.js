class Producer {
    ...
    get buyamount(){
      if(!this.unlocked)
        return "Locked";
      if(player.options.buyamounts[this.buykey] == undefined || player.options.buyamounts[this.buykey].equal == undefined)
        player.options.buyamounts[this.buykey] = new Decimal(1);
